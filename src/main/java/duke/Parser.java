...
class Parser {
     ...
     * @return An array of strings, where the first element is the command and the second element is the arguments (can be null if no arguments).
     */
     ...
     * @return An array of strings, where the first element is the description and the second element is the deadline time string.
     */
     ...
     * Splits the arguments string by " /from " and " /to " to separate the description, from time string, and to time string.
     *
     * @param arguments The arguments string for the event command.
     * @return An array of strings, where the first element is the description, the second is the from time string, and the third is the to time string.
     */
